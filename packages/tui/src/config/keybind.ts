...
export const Definitions = {
  ...
  session_pending_prompt_cancel: keybind("<leader>d", "Cancel latest queued follow-up"),
  session_delivery_toggle: keybind("<leader>w", "Toggle queue mode for follow-up prompts"),
...
export const CommandMap = {
  ...
  session_pending_prompt_cancel: "session.pending_prompt.cancel",
  session_delivery_toggle: "session.delivery.toggle",
